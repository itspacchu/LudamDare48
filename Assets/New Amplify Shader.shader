	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_42_0_g1 = tex2D( _TextureSample0, IN.ase_texcoord7.xy );
				...
				float cameraDepthFade10 = (( eyeDepth -_ProjectionParams.y - _offset ) / _Length);
				dither14 = step( dither14, cameraDepthFade10 );
